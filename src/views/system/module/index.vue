<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="模块code" align="center" prop="code" />
...
const handleExport = async () => {
  try {
    ...
    const data = await ModuleApi.exportModule(queryParams)
    download.excel(data, '业务模块.xls')
  } catch {
  } finally {
